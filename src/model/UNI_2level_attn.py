...
class UNI_2Level_attn(nn.Module):
    ...
    def forward(self, x):
        ...
        final_cell = torch.cat([cell_cont, cls_cell], dim=1)
        out = self.classifier(final_cell)
        
        # the below return is for the best
        return out, final_cell, 0
    
    def apply_lora_to_vit(self, lora_r, lora_alpha, first_layer_start=20):
        """
