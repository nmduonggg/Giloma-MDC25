...
test_dataset = RealTimeCroppedDualPatchDataset(image_dir=TEST_DIR, data_path=test_data_path, mode='real_testing')
# Initialize dataloaders
...
model = ResNetProvKD_RealTime(num_classes=2)      # Set pretrained=True if you want to use pretrained weights
...
if __name__ == '__main__':
    # Start training
    checkpoint_path = '/home/manhduong/ISBI25_Challenge/Giloma-MDC25/src/checkpoints/best_model_Resnet_Prov_Dual_scratch_augment_realtime_crop_local_context_wO.pth'
